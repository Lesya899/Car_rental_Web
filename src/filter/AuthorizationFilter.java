  ...
  public class AuthorizationFilter implements Filter {
      ...
      private static final Set<String> ADMIN_PATHS = Set.of(LOGIN,LOGOUT, CARS, CAR_DESCRIPTION, ALL_REQUESTS_RENT_CAR, ADMIN, LOCALE);
     ...
     public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
      ...
      //если пользователь зарегистрирован с ролью USER
      private boolean isUserLoggedIn(ServletRequest servletRequest) {
          var user = (UserDto) ((HttpServletRequest) servletRequest).getSession().getAttribute("user");
          return  user!=null && user.getRole()==Role.USER;
      }

     //если пользователь зарегистрирован с ролью ADMIN
